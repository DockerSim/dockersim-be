...
public class ContainerCreate implements Callable<CommandResult> {
    ...
    public CommandResult call() throws Exception {
        DockerContainerResponse container = service.create(parent.getPrincipal(), baseImageNameOrHexId, name);

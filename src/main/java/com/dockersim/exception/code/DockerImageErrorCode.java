...
public enum DockerImageErrorCode implements ResponseCode {
    ...
    PULL_BY_ID_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "D024", "이미지 ID로 이미지를 pull할 수 없습니다. repository:tag 형식으로 시도해주세요."),
    PUSH_BY_ID_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "D025", "이미지 ID로 이미지를 push할 수 없습니다. repository:tag 형식으로 시도해주세요.");

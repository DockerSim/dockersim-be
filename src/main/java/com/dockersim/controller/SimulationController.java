...
public class SimulationController {
    ...
    public ResponseEntity<ApiResponse<SimulationResponse>> getSimulation(
        ...
        @Parameter(description = "조회할 시뮬레이션 ID") @PathVariable String simulationId
    ) {
    ...
    public ResponseEntity<ApiResponse<SimulationResponse>> updateSimulation(
        @Parameter(description = "수정할 시뮬레이션 ID") @PathVariable String simulationId,
        @Parameter(hidden = true) @AuthenticationPrincipal String userId,
    ...
    public ResponseEntity<ApiResponse<Void>> deleteSimulation(
        @Parameter(hidden = true) @AuthenticationPrincipal String userId,
        @Parameter(description = "삭제할 시뮬레이션 ID") @PathVariable String simulationId
    ) {
    ...
    public ResponseEntity<ApiResponse<CollaboratorResponse>> inviteCollaborator(
        @Parameter(hidden = true) @AuthenticationPrincipal String userId,
        @Parameter(description = "협업자를 초대할 시뮬레이션 ID") @PathVariable String simulationId,
    ...
    public ResponseEntity<ApiResponse<List<CollaboratorResponse>>> getCollaborators(
        @Parameter(description = "협업자를 조회할 시뮬레이션 ID") @PathVariable String simulationId,
        @Parameter(hidden = true) @AuthenticationPrincipal String userId
    ) {
        return ResponseEntity.ok(ApiResponse.success(
    ...
    public ResponseEntity<ApiResponse<Void>> removeCollaborator(
        @Parameter(description = "협업자를 제거할 시뮬레이션 ID") @PathVariable String simulationId,

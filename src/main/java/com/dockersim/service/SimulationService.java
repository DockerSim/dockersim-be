...
import com.dockersim.domain.ShareState;
import com.dockersim.domain.Simulation;
import com.dockersim.domain.SimulationCollaborator;
import com.dockersim.domain.User;
import com.dockersim.dto.request.CreateSimulationRequest;
import com.dockersim.dto.request.InviteCollaboratorRequest;
...
public class SimulationService {
    ...
    public SimulationResponse updateShareState(Long simulationId, Long ownerId,
        ...
        if (!sim.isOwner(userRepository.findById(ownerId)
            .orElseThrow(
                () -> new BusinessException(SimulationErrorCode.SIMULATION_NOT_FOUND, ownerId)))) {
    ...
    public CollaboratorResponse inviteCollaborator(Long simulationId, Long ownerId,
        ...
        sim.addCollaborator(invitee, owner);
    ...
    public List<CollaboratorResponse> getCollaborators(Long simulationId, Long userId) {
        ...
        User user = userRepository.findById(userId)
            .orElseThrow(
                () -> new BusinessException(SimulationErrorCode.SIMULATION_NOT_FOUND, userId));

        if (!sim.hasAccess(user)) {
            throw new BusinessException(SimulationErrorCode.SIMULATION_ACCESS_DENIED, simulationId,
                userId);
        }
    ...
    public void removeCollaborator(Long simulationId, Long collaboratorUserId, Long requesterId) {
        ...
        User requester = userRepository.findById(requesterId)
            .orElseThrow(
                () -> new BusinessException(SimulationErrorCode.SIMULATION_NOT_FOUND, requesterId));
